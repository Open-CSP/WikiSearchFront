...
<div class="wssearch--hit" >
             ...
             <template v-for="(hitID, key) in $parent.hitIDs">
                <span class="wssearch--hit__link" v-if="Object.keys($parent.hitIDs)[0] == key"><a  v-bind:href="href" >{{hit._source["P:" + key ][hitID][0]}}</a></span>
