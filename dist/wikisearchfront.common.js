...
// CONCATENATED MODULE: ./src/App.vue?vue&type=template&id=d77b14b2&
...
/* harmony default export */ var Appvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    sortClass: function sortClass() {
      ...
      return "wss-order--".concat((_this$state$sortOrder = this.state.sortOrderType) !== null && _this$state$sortOrder !== void 0 ? _this$state$sortOrder : 'score', "--").concat((_this$state$sortOrder2 = this.state.sortOrder) !== null && _this$state$sortOrder2 !== void 0 ? _this$state$sortOrder2 : 'desc');
    },
